      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <motion.div
            ...
            className="text-xl lg:text-2xl font-bold text-blue-600 ml-16 md:ml-0"
          >
            Jutehk
          </motion.div>
        ...
        <motion.div
          ...
          className="md:hidden overflow-hidden bg-white/95 backdrop-blur-md rounded-lg mt-2 mx-4"
        >
